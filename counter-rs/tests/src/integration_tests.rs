...
mod tests {
    use casper_engine_test_support::{
        Code, Session, SessionBuilder, TestContext, TestContextBuilder,
    };
    use casper_types::{
    ...
    impl CounterContract {
        pub fn deploy() -> Self {
            ...
            let mut context = TestContextBuilder::new()
                ...
                .build();
            let define_session = CounterContract::create_session(
                Code::from("counter-define.wasm"),
                runtime_args! {},
                account_addr,
            );
        ...
        pub fn increment_with_endpoint_call(&mut self) {
            ...
            let session =
                CounterContract::create_session(session_code, runtime_args! {}, self.account_addr);
        ...
        pub fn increment_with_wasm(&mut self) {
            ...
            let session =
                CounterContract::create_session(call_code, runtime_args! {}, self.account_addr);
            self.context.run(session);
        }
